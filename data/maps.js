export const MAPS = [
  {
    id: 'grass', name: 'Forest Trail', icon: '🌲', theme: ['#16331f', '#2a6a38', '#8ddf67'],
    description: 'Forest map with tomato, carrot, onion, watermelon, and pumpkin waves.',
    veggieIcons: ['🍅', '🥕', '🧅', '🍉', '🎃'], wavesToWin: 10,
  ...
  {
    id: 'desert', name: 'Dune Split', icon: '🏜️', theme: ['#5a3715', '#a76a16', '#f6c453'],
    description: 'Desert split map with onion, carrot, potato, pumpkin, and melon waves.',
    veggieIcons: ['🧅', '🥕', '🥔', '🎃', '🍉'], wavesToWin: 12,
  ...
  {
    id: 'ice', name: 'Frost Loop', icon: '🧊', theme: ['#123d5a', '#0ea4c5', '#abf2ff'],
    description: 'Ice map with pea pod, onion, cabbage, melon, and pumpkin waves.',
    veggieIcons: ['🫛', '🧅', '🥬', '🍈', '🎃'], wavesToWin: 14,
  ...
  {
    id: 'lava', name: 'Molten Cross', icon: '🌋', theme: ['#501515', '#b42828', '#ff8e6b'],
    description: 'Lava map with chili, pepper, carrot, pumpkin, and watermelon waves.',
    veggieIcons: ['🌶️', '🫑', '🥕', '🎃', '🍉'], wavesToWin: 16,
  ...
  {
    id: 'temple', name: 'Temple Maze', icon: '🏛️', theme: ['#241d54', '#6a39b8', '#d9adff'],
    description: 'Temple map with potato, garlic, onion, pumpkin, and watermelon waves.',
    veggieIcons: ['🥔', '🧄', '🧅', '🎃', '🍉'], wavesToWin: 18,
